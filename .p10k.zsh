# Generated by Powerlevel10k configuration wizard on 2026-04-21 at 11:11 MDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_ASDF_FOREGROUND=4
  ...
  typeset -g POWERLEVEL9K_ASDF_RUBY_FOREGROUND=5
  ...
  typeset -g POWERLEVEL9K_ASDF_RUST_FOREGROUND=6
  ...
  typeset -g POWERLEVEL9K_ASDF_PERL_FOREGROUND=4
  ...
  typeset -g POWERLEVEL9K_VI_MODE_INSERT_FOREGROUND=4
  # Custom icon.
  # typeset -g POWERLEVEL9K_VI_MODE_VISUAL_IDENTIFIER_EXPANSION='⭐'

  ######################################[ ram: free RAM ]#######################################
  # RAM color.
  typeset -g POWERLEVEL9K_RAM_FOREGROUND=4
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_LOAD_NORMAL_FOREGROUND=4
  ...
  #############[ rbenv: ruby version from rbenv (https://github.com/rbenv/rbenv) ]##############
  # Rbenv color.
  typeset -g POWERLEVEL9K_RBENV_FOREGROUND=5
  ...
  #######################[ rvm: ruby version from rvm (https://rvm.io) ]########################
  # Rvm color.
  typeset -g POWERLEVEL9K_RVM_FOREGROUND=5
  ...
  ###########[ perlbrew: perl version from perlbrew (https://github.com/gugod/App-perlbrew) ]############
  # Perlbrew color.
  typeset -g POWERLEVEL9K_PERLBREW_FOREGROUND=4
  ...
  typeset -g POWERLEVEL9K_GOOGLE_APP_CRED_CLASSES=(
      ...
      # '*:*test*:*'  TEST    # to match your needs. Customize them as needed.
      '*'             DEFAULT)
  typeset -g POWERLEVEL9K_GOOGLE_APP_CRED_DEFAULT_FOREGROUND=4
  ...
  ###############################[ public_ip: public IP address ]###############################
  # Public IP color.
  typeset -g POWERLEVEL9K_PUBLIC_IP_FOREGROUND=3
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_IP_CONTENT_EXPANSION='${P9K_IP_RX_RATE:+%2F⇣$P9K_IP_RX_RATE }${P9K_IP_TX_RATE:+%3F⇡$P9K_IP_TX_RATE }%6F$P9K_IP_IP'
